...
preCodeHeader = HTML
preCodeHeader.value = <div id="body-wrapper"><div id="header-outter">
postCodeHeader = HTML
postCodeHeader.value = </div>

preCodeFeature = HTML
preCodeFeature.value  = <div id="feature-outter">
postCodeFeature = HTML
postCodeFeature.value = </div>

preCodeContent = HTML
preCodeContent.value = <div id="pageWrap">
...
#the <div class="clear"></div> below is important
preCodeFooter = HTML
preCodeFooter.value = </div><div class="clear"></div></div><div id="footer-outter">
postCodeFooter = HTML
postCodeFooter.value = </div>
...
footer = COA
footer {
	wrap = <div id="footer"> | <div class="clear"></div></div>
	10 = TEXT
	10.data = date:U
	10.strftime = %Y
