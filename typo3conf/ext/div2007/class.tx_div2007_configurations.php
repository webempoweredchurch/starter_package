 ...
 * @version    SVN: $Id: class.tx_div2007_configurations.php 82 2011-07-19 15:04:37Z franzholz $
 * @since      0.1
 */
...
class tx_div2007_configurations extends tx_div2007_object {
	 ...
	 * The provided pathKey is relative to the part of the TS-Setup you have loaded. Examples:
	 *
	 * @see		tx_div2007_configurations::get()
	 * @param	string		relative setupPath
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/div2007/class.tx_div2007_configurations.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/div2007/class.tx_div2007_configurations.php']);
}
?>
