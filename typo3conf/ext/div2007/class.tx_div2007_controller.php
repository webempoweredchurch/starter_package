 ...
 * You can exchange the default designator by the function setDefaultDesignator(). (See: tx_div2007_selfAwarness)
 *
 *
 * $TYPO3_CONF_VARS['CONTROLLERS']. (See: _findControllerAndAction()).
 *
 *
 * Depends on: tx_div2007, tx_div2007_object <br>
...
class tx_div2007_controller extends tx_div2007_object {
	...
	public $configurationsClassName = 'tx_div2007_configurations'; // You may overwrite this in your subclass with an own configurations class.
	public $parametersClassName = 'tx_div2007_parameters'; // Typically you don't need to make a subclass of this.
	public $context; // Object containing the context accessing object.
	public $configurations; // Object containing the configuration.
	public $parameters; // Object containing the request parameters.
	public $defaultAction = 'defaultAction'; // Default action.
	public $action; // Determined action.
	public $input; // The input string.
	public $output; // The output string.
	 ...
	 *
	 * @param	object		tx_div2007_configurations or child
	 * @return	object		tx_div2007_configurations or child
	 */
	 ...
	 *
	 * @param	object		tx_div2007_parameters or child
	 * @return	object		tx_div2007_parameters or child
	 */
	 ...
	 *
	 * @param	object		tx_div2007_context or child
	 * @return	object		tx_div2007_context or child
	 */
	 ...
	 * @access	protected
	 */
	public function _findControllerAndAction () {
	 ...
	 * @access	protected
	 */
	public function _getParameterAction () {
	 ...
	 * @access	protected
	 */
	public function _runAction ($controller) {
	 ...
	 * @access	protected
	 */
	public function _runAfterAction ($controller) {
	 ...
	 * @access	protected
	 */
	public function _runBeforeAction ($controller) {
	 ...
	 * @access	protected
	 */
	public function _runControllerAndAction ($controllerAndAction) {
	 ...
	 * @access	protected
	 */
	public function _typoScriptHasAction ($action) {
		return (strlen($action) && is_object($this->configurations) && in_array($action, (array) $this->configurations->get('actions.')));
	}

}

if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/div2007/class.tx_div2007_controller.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/div2007/class.tx_div2007_controller.php']);
}
?>
