...
preCodeHeader = HTML
preCodeHeader.value =<div id="pageWrap-outter-1"> <div id="pageWrap-outter-2"><div id="pageWrap">
postCodeHeader >
...
preCodeContent = HTML
preCodeContent.value = <div id="content-wrapper">
...
preCodeFooter = HTML
preCodeFooter.value (
	<div class="clearOnly"></div></div></div></div></div><!-- end #pageWrap  -->
)
postCodeFooter >
...
globalMenu {
	entryLevel = 0
	wrap = <div id="menu-wrapper"><ul id="globalMenu">|</ul></div><!-- end #globalMenu  -->
...
additionalDocHeadCode.value (
	...
	<script type="text/javascript" src="{$templavoila_framework.skinPath}js/jquery.hoverIntent.minified.js"></script>
)
