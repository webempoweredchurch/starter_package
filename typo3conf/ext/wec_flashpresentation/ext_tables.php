...
t3lib_extMgm::addPiFlexFormValue($_EXTKEY.'_pi1', 'FILE:EXT:wec_flashpresentation/flexform_ds_video.xml');
...
t3lib_extMgm::addPiFlexFormValue($_EXTKEY.'_pi2', 'FILE:EXT:wec_flashpresentation/flexform_ds_audio.xml');

// t3lib_extMgm::addStaticFile($_EXTKEY,"pi1/static/", "Flash Presentation");
