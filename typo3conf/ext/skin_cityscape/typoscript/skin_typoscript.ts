...
preCodeContent = HTML
preCodeContent.value = <div id="contentWrap-outer"><div id="contentWrap">
...
globalMenu.2 {
	...
	IFSUB = 1
	IFSUB {
		wrapItemAndSub = <li class="dir-level2"> | </li>
		}
}
...
header >
header = COA
header.wrap = <div id="header"> | </div><div class="clear"></div>
...
### top nagivation
header.10 = COA
header.10.stdWrap.wrap = <div id="topNavWrap"><div id="topNav"> | <div class="clear"></div></div></div>
...
additionalDocHeadCode.value (
	...
	<!--[if lte IE 7]>
	<script type="text/javascript" src="{$templavoila_framework.skinPath}js/jquery.js"></script>
